      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
            ...
            else
            {
                ...
                //use tow points that moke the path tangent to the previous path's end point
            ...
            //In renet add evenly 30m spaced points ahead of the starting reference
            ...
            for (int i = 1; i <= 50-previous_path_x.size(); i++){
                ...
                double tmp_x = roundf(x_point*100);
                tmp_x = tmp_x/100;
                double tmp_y = roundf(y_point*100);
                tmp_y = tmp_y/100;
